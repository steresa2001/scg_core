$(document).ready(function() {
	(function(poker, $, undefined) {
		...
		function createDeckOfCards() {
			for(var i = 1; i < 53; i++) {
				var buildImage = '<img class="this-card" src="./images/cards/' + i +'.png"' + ' width="215" height="300" alt="Card" />';
		...
		function addHoldCardImages() {
			for(var i = 1; i < 6; i++) {
				var holdCardImage = '<img id="hold-slot-' + i + '"' + ' src="./images/cards/hold.png"' + ' width="169" height="70" alt="hold" />';
		...
		function dealCards() {
			...
			// cards[1] = '<img class="this-card" src="./images/cards/' + 2 +'.png"' + ' width="215" height="300" alt="Card" />';
			// cards[2] = '<img class="this-card" src="./images/cards/' + 3 +'.png"' + ' width="215" height="300" alt="Card" />';
			// cards[3] = '<img class="this-card" src="./images/cards/' + 4 +'.png"' + ' width="215" height="300" alt="Card" />';
			// cards[4] = '<img class="this-card" src="./images/cards/' + 5 +'.png"' + ' width="215" height="300" alt="Card" />';
			// cards[5] = '<img class="this-card" src="./images/cards/' + 19 +'.png"' + ' width="215" height="300" alt="Card" />';
		...
		function chips(value) {
			...
			var chip = 'chip' + value;
			chip = '<img id="chip-'+ value + '" ' + 'class="chip-'+ value + '" ' + 'src="./images/chip_'+ value + '.png" ' + 'width="117" height="117" alt="' + value + '" />';
